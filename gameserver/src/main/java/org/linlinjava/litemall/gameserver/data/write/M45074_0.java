...
public class M45074_0 extends BaseWrite {
    protected void writeO(ByteBuf writeBuf, Object object) {
        List<Vo_45074_0> object1 = (List) object;
        GameWriteTool.writeByte(writeBuf, Integer.valueOf(object1.size()));
        for (int i = 0; i < object1.size(); i++) {
            Vo_45074_0 obj = (Vo_45074_0) object1.get(i);

            GameWriteTool.writeString(writeBuf, obj.guardName);

            GameWriteTool.writeShort(writeBuf, Integer.valueOf(obj.guardLevel));

            GameWriteTool.writeShort(writeBuf, Integer.valueOf(obj.guardIcon));

            GameWriteTool.writeShort(writeBuf, Integer.valueOf(obj.guardOrder));

            GameWriteTool.writeInt(writeBuf, Integer.valueOf(obj.guardId));
        }
    }
