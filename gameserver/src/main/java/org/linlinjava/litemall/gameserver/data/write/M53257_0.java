...
public class M53257_0 extends org.linlinjava.litemall.gameserver.netty.BaseWrite {
    protected void writeO(ByteBuf writeBuf, Object object) {
        ...
        GameWriteTool.writeByte(writeBuf, Integer.valueOf(object1.vipType));
        ...
        GameWriteTool.writeByte(writeBuf, Integer.valueOf(object1.isGet));

        GameWriteTool.writeByte(writeBuf, Integer.valueOf(object1.tempInsider));
    }
