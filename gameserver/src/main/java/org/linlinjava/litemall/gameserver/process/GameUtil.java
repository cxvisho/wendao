...
public class GameUtil {
    ...
    public static void addfabaojingyan(Chara chara1, int jingyan) {
        ...
        if (has.booleanValue()) {
            ...
            GameObjectCharMng.getGameObjectChar(chara1.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M20481_0(), vo_20481_0);
        }
    }
    ...
    public static Boolean fabaojingyan(Chara chara1, int jingyan) {
        ...
        for (int i = 0; i < chara1.backpack.size(); i++) {
            if (((Goods) chara1.backpack.get(i)).pos == 9) {
                ...
                GameObjectCharMng.getGameObjectChar(chara1.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M65527_0(), listVo_65527_0);
                ((Goods) chara1.backpack.get(i)).goodsInfo.pot += jingyan;
                List<Goods> list = new ArrayList();
                list.add(chara1.backpack.get(i));
                GameObjectCharMng.getGameObjectChar(chara1.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M65525_0(), list);
        ...
        if (replace.equals("地星")) {
            ...
            for (int j = 0; j < duiyuan.pets.size(); j++) {
                if (((Petbeibao) duiyuan.pets.get(j)).id == duiyuan.chongwuchanzhanId) {
                    ...
                    int intimacy = 33 * level / (petShuXing.intimacy > base_pet_dh ? petShuXing.intimacy / base_pet_dh : 1);
                    petShuXing.intimacy += intimacy;
                    org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0 vo_20481_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0();
                    vo_20481_0.msg = ("宠物获得武学#R" + intimacy);
                    vo_20481_0.time = ((int) (System.currentTimeMillis() / 1000L));
                    GameObjectCharMng.getGameObjectChar(duiyuan.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M20481_0(), vo_20481_0);
                }
    ...
    public static void shidaojingyan(Chara chara1, Chara duiyuan, int id) {
        ...
        for (int i = 0; i < duiyuan.pets.size(); i++) {
            if (((Petbeibao) duiyuan.pets.get(i)).id == duiyuan.chongwuchanzhanId) {
                ...
                int base_pet_dh = (int) (0.29D * petShuXing.skill * petShuXing.skill * petShuXing.skill);
                int intimacy = 33 * petShuXing.skill / (petShuXing.intimacy > base_pet_dh ? petShuXing.intimacy / base_pet_dh : 1);
                petShuXing.intimacy += intimacy;
                org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0 vo_20481_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0();
                vo_20481_0.msg = ("宠物获得武学#R" + intimacy);
                vo_20481_0.time = ((int) (System.currentTimeMillis() / 1000L));
    ...
    public static void nextxuanshang(Chara chara1, Chara duiyuan) {
        ...
        GameObjectChar.sendduiwu(new org.linlinjava.litemall.gameserver.data.write.M12285_1(), Integer.valueOf(((org.linlinjava.litemall.gameserver.data.vo.Vo_65529_0) chara1.npcxuanshang.get(0)).id), chara1.id);
        ...
        for (int i = 0; i < duiyuan.pets.size(); i++) {
            if (((Petbeibao) duiyuan.pets.get(i)).id == duiyuan.chongwuchanzhanId) {
                PetShuXing petShuXing = (PetShuXing) ((Petbeibao) duiyuan.pets.get(i)).petShuXing.get(0);
                int base_pet_dh = (int) (0.29D * petShuXing.skill * petShuXing.skill * petShuXing.skill);
                int intimacy = 29 * petShuXing.skill / (petShuXing.intimacy > base_pet_dh ? petShuXing.intimacy / base_pet_dh : 1);
                petShuXing.intimacy += intimacy;
                org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0 vo_20481_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0();
                vo_20481_0.msg = ("宠物获得武学#R" + intimacy);
                vo_20481_0.time = ((int) (System.currentTimeMillis() / 1000L));
    ...
    public static void adddaohang(Chara chara, int daohangdian) {
        ...
        vo_20481_0.time = ((int) (System.currentTimeMillis() / 1000L));
        GameObjectCharMng.getGameObjectChar(chara.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M20481_0(), vo_20481_0);
    }
    ...
    public static void nextshuadao(Chara chara1, Chara duiyuan) {
        ...
        duiyuan.shuadao += 1;
        GameObjectChar.sendduiwu(new org.linlinjava.litemall.gameserver.data.write.M12285_1(), Integer.valueOf(((org.linlinjava.litemall.gameserver.data.vo.Vo_65529_0) chara1.npcshuadao.get(0)).id), chara1.id);
        ...
        if (duiyuan.shuadao <= 400) {
            ...
            for (int i = 0; i < duiyuan.pets.size(); i++) {
                if (((Petbeibao) duiyuan.pets.get(i)).id == duiyuan.chongwuchanzhanId) {
                    ...
                    int intimacy = (int) (22 * petShuXing.skill * (1.0D + 0.2D * chubao) / (petShuXing.intimacy > base_pet_dh ? petShuXing.intimacy / base_pet_dh : 1) * beishu);
    ...
    public static void chubaorenwu(Chara chara1, Chara duiyuan) {
        ...
        GameObjectChar.sendduiwu(new org.linlinjava.litemall.gameserver.data.write.M12285_1(), Integer.valueOf(((org.linlinjava.litemall.gameserver.data.vo.Vo_65529_0) chara1.npcchubao.get(0)).id), chara1.id);
        ...
        if (duiyuan.chubao < 21) {
            ...
            for (int i = 0; i < duiyuan.pets.size(); i++) {
                if (((Petbeibao) duiyuan.pets.get(i)).id == duiyuan.chongwuchanzhanId) {
                    PetShuXing petShuXing = (PetShuXing) ((Petbeibao) duiyuan.pets.get(i)).petShuXing.get(0);
                    int base_pet_dh = (int) (0.29D * petShuXing.skill * petShuXing.skill * petShuXing.skill);
                    int intimacy = (int) (13 * petShuXing.skill * (1.0D + 0.2D * chubao) / (petShuXing.intimacy > base_pet_dh ? petShuXing.intimacy / base_pet_dh : 1));
                    petShuXing.intimacy += intimacy;
                    org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0 vo_20481_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0();
                    vo_20481_0.msg = ("宠物获得武学#R" + intimacy);
                    vo_20481_0.time = ((int) (System.currentTimeMillis() / 1000L));
        ...
        if (chara1.mapid == ((org.linlinjava.litemall.gameserver.data.vo.Vo_65529_0) chara1.npcchubao.get(0)).mapid) {
            GameObjectChar.sendduiwu(new org.linlinjava.litemall.gameserver.data.write.M65529_0(), chara1.npcchubao.get(0), chara1.id);
        }
    ...
    public static void chenghaoxiaoxi(Chara chara) {
        ...
        GameObjectCharMng.getGameObjectChar(chara.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M62209_0(), list);
    }
    ...
    public static void addpetjingyan(Petbeibao petbeibao, int jingyan, Chara chara) {
        ...
        if ((petShuXing.pot >= petShuXing.resist_poison) && (petShuXing.skill < 125)) {
            ...
            list.add(petbeibao);
            GameObjectCharMng.getGameObjectChar(chara.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M65507_0(), list);
        }
        List list = new ArrayList();
        list.add(petbeibao);
        GameObjectCharMng.getGameObjectChar(chara.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M65507_0(), list);
    ...
    public static void addjingyan(Chara chara, int jingyan) {
        ...
        if ((chara.pot >= chara.resist_poison) && (chara.level < 128)) {
            ...
            ListVo_65527_0 listVo_65527_0 = a65527(chara);
            GameObjectCharMng.getGameObjectChar(chara.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M65527_0(), listVo_65527_0);
        }
    }
    ...
    public static List<JiNeng> dujineng(int leixing, int pos, int level, boolean isMagic, int id, Chara chara) {
        ...
        GameObjectCharMng.getGameObjectChar(chara.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M32747_0(), vo_32747_0List);
    ...
    public static void a20467(Chara chara, int id, String ask_type) {
        ...
        GameObjectCharMng.getGameObjectChar(id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M20467_0(), vo_20467_0);
    }
    ...
    public static void a4121(List<org.linlinjava.litemall.gameserver.data.vo.Vo_4121_0> charaList) {
        ...
        for (org.linlinjava.litemall.gameserver.data.vo.Vo_4121_0 vo41210 : charaList) {
            GameObjectCharMng.getGameObjectChar(vo41210.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M4121_0(), vo_4121_0List);
        }
    }
    ...
    public static void a4119(List<Chara> charaList) {
        ...
        for (Chara chara : charaList) {
            GameObjectCharMng.getGameObjectChar(chara.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M45074_0(), list);
            GameObjectCharMng.getGameObjectChar(chara.id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M4119_0(), vo_4119_0List);
        }
    }
