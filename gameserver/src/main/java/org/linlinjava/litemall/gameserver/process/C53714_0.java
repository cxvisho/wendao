    ...
    public void process(ChannelHandlerContext ctx, ByteBuf buff) {
        ...
        for (int i = 0; i < chara.backpack.size(); i++) {
            if (((Goods) chara.backpack.get(i)).pos == 37) {
                PackModification packModification = GameData.that.basePackModificationService.findOneByStr(((Goods) chara.backpack.get(i)).goodsInfo.str);
        ...
        GameObjectChar.send(new org.linlinjava.litemall.gameserver.data.write.M53713_0(), vo_53713_0);
