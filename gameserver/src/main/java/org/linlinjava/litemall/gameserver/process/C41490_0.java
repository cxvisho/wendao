...
public class C41490_0 implements org.linlinjava.litemall.gameserver.GameHandler {
    public void process(ChannelHandlerContext ctx, ByteBuf buff) {
        String equip_str = org.linlinjava.litemall.gameserver.data.GameReadTool.readString(buff);

        PackModification packModification = GameData.that.basePackModificationService.findOneByStr(equip_str);
        Chara chara = GameObjectChar.getGameObjectChar().chara;


        if (packModification.getCategory().intValue() == 1) {
            ...
            chara.special_icon = Integer.valueOf(packModification.getFasionType()).intValue();
        ...
        if (packModification.getCategory().intValue() == 2) {
            for (int i = 0; i < chara.backpack.size(); i++) {
        ...
        if (packModification.getCategory().intValue() == 3) {
            org.linlinjava.litemall.gameserver.data.vo.Vo_4197_0 vo_4197_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_4197_0();
            vo_4197_0.id = 0;
