        ...
        for (int i = 0; i < chara.backpack.size(); i++) {
            if (((Goods) chara.backpack.get(i)).pos == pos) {
                ...
                if (goods.goodsInfo.str.equals("超级藏宝图")) {
                    ...
                    GameObjectChar.send(new org.linlinjava.litemall.gameserver.data.write.M61553_0(), vo_61553_0);
                    ...
                    GameObjectChar.getGameObjectChar();
                    GameObjectChar.send(new org.linlinjava.litemall.gameserver.data.write.M45063_0(), vo_45063_0);
